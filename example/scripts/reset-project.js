 ...
 * It deletes or moves the /src and /scripts directories to /example1 based on user input and creates a new /src/app directory with an index.tsx and _layout.tsx file.
...
const moveDirectories = async (userInput) => {
  try {
    if (userInput === 'y') {
      // Create the app-example1 directory
      await fs.promises.mkdir(exampleDirPath, { recursive: true });
      console.log(`📁 /${exampleDir} directory created.`);
    }

    // Move old directories to new app-example1 directory or delete them
...
rl.question(
  'Do you want to move existing files to /example1 instead of deleting them? (Y/n): ',
  (answer) => {

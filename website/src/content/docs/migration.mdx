...
Android's fade curve was also retuned in this release (eased instead of linear) so the default renders a visible blur body — see [issue #119](https://github.com/sbaiahmed1/react-native-blur/issues/119).

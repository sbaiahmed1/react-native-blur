...
export const liquidGlassViewProps: PropRow[] = [
  ...
  },
  {
    ...
    default: "'clear'",
    platform: 'iOS 26+, Android 13+',
    description: 'The tint color for the glass effect. Accepts hex colors or color names. Modulated by the glass shader on both platforms.',
  },
  {
    name: 'glassOpacity',
    type: 'number',
  ...
  },
  {
    ...
    description: 'Controls whether the liquid glass effect is interactive and reacts to touch (iOS 26+; on Android it toggles an iOS-style press-scale animation).',
  },
  {
    name: 'ignoreSafeArea',
    type: 'boolean',

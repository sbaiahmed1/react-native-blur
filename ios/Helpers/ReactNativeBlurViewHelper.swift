...
@objc public class ReactNativeBlurViewHelper: NSObject {
  ...
  /// Updates the blur view with a new ignoreAccessibilityFallback value.
  @objc public static func updateBlurView(_ blurView: AdvancedBlurView, withIgnoringAccessibilityFallback ignoreAccessibilityFallback: Bool) {
